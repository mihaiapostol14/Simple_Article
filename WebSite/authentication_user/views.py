...
class CreateUserView(CreateView, AuthorizationUserMixin):  # README: CreateUserView 👈
    ...
    def get_success_url(self):
        messages.success(request=self.request,
                         message=f'Registration {self.request.user} Successful')
...
class ChangeUserPasswordView(AuthorizationUserMixin, PasswordChangeView): # README: ChangeUserPasswordView 👈
    ...
    def get_success_url(self):
        messages.success(
            request=self.request, message=f'Change Password {self.request.user} Successful')
        return reverse_lazy('authentication_user:login-user')
...
# class UpdateUserView(LoginRequiredMixin, AuthorizationUserMixin, UpdateView): # README: UpdateUserView 👈
#     model = User
#     form_class = RegistrationUserForm
