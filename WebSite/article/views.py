...
class CreateArticleView(LoginRequiredMixin, ArticleMixin, CreateView): # README: CreateArticleView 👈
    model = Article
...
class ArticleListView(ArticleMixin, ListView): # README: ArticleListView 👈
    model = Article
...
class ArticleDetailView(ArticleMixin, DetailView): # README: ArticleDetailView 👈
    model = Article
...
class UpdateArticleView(LoginRequiredMixin, ArticleMixin, UpdateView): # README: UpdateArticleView 👈
    model = Article
    form_class = CreateArticleForm
...
class DeleteArticleView(LoginRequiredMixin, ArticleMixin, DeleteView): # README: DeleteArticleView 👈
    model = Article
